    ...
    <section className="bg-[#090D16] py-24">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="text-center">
          <span className="rounded-full border border-red-500/20 px-4 py-2 text-sm text-red-400">
            Masalah Umum Proyek
          </span>
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {problems.map((problem) => (
            <div
              key={problem}
              className="rounded-2xl border border-red-500/10 bg-[#1E293B]/50 p-6 transition hover:border-red-500/40"
            >
