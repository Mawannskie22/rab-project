    ...
    >
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
        ...
        <nav className="hidden gap-8 md:flex">
          ...
          <a href="/portfolio" className="text-slate-300 hover:text-[#00F5D4]">
            Portfolio
          </a>

          <a href="/kontak" className="text-slate-300 hover:text-[#00F5D4]">
            Kontak
          </a>
        </nav>
      ...
      {isOpen && (
        <div className="border-t border-white/10 bg-[#090D16] md:hidden">
          <nav className="flex flex-col p-6">
            ...
            <a href="/portfolio" className="py-3 text-slate-300">
              Portfolio
            </a>

            <a href="/kontak" className="py-3 text-slate-300">
              Kontak
            </a>
