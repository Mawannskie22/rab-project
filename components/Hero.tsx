      ...
      <div className="mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-2">
        ...
        <Reveal x={-30}>
          ...
          <p className="mt-8 max-w-xl text-lg text-slate-400">
            Membantu kontraktor, owner, developer, dan konsultan
            mengendalikan biaya, cashflow, schedule pekerjaan,
            serta kebutuhan material agar proyek lebih terukur,
            efisien, dan minim risiko kerugian.
          </p>
